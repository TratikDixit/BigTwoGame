import java.util.*;
/**
 * This class is a subclass of the Hand class, and is used to model a hand of StraightFlush.
 * 
 * @author Tratik Dixit
 *
 */
public class StraightFlush extends Hand{
	...
	public boolean isValid() {
	    ...
	    // checks if the card form a flush
		for (int i = 0 ; i<4 ;i+=1)
		{
		...
		for(int i=0;i<4;i++) {
			if((orderOfCards.get(i)+1) != orderOfCards.get(i+1)) 
			{
						return false;
			}
		}
